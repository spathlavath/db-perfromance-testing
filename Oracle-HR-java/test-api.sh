...
echo "==> Testing Oracle HR Java V2 Application with Custom New Relic Agent"
...
echo "   docker-compose logs oracle-hr-app | grep 'Executing prepared SQL'"
echo ""
echo "4. Verify all queries use prepared statements (look for '?' placeholders):"
echo "   docker-compose logs oracle-hr-app | grep 'PreparedStatement'"
